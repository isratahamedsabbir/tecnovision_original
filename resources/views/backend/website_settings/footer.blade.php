                    ...
                    <div class="card shadow-none bg-light">
    					...
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
								...
								<!-- About description -->
    			                <div class="form-group">
    								<label>{{ translate('Footer address') }} ({{ translate('Translatable') }})</label>
    								<input type="hidden" name="types[][{{ $lang }}]" value="footer_address">
    								<textarea class="form-control" name="footer_address" rows="6" placeholder="Type.." >{{ get_setting('footer_address',null,$lang); }}</textarea>
    							</div>
								<div class="form-group">
    								<label>Copyright</label>
    								<input type="hidden" name="types[][{{ $lang }}]" value="copyright">
    								<textarea class="form-control" name="copyright" rows="6" placeholder="copyright &copy <?= date('Y').' '.env('APP_NAME'); ?>" >{{ get_setting('copyright',null,$lang); }}</textarea>
    							</div>
								<!-- Update Button -->
                    ...
                    <div class="card shadow-none bg-light">
    					...
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
								...
								<!-- Contact email -->
                                <div class="form-group">
    								<label>{{ translate('Contact whatsapp') }}</label>
    								<input type="hidden" name="types[]" value="contact_whatsapp">
    								<input type="text" class="form-control" placeholder="{{ translate('Phone') }}" name="contact_whatsapp" value="{{ get_setting('contact_whatsapp') }}">
    							</div>
								<!-- Update Button -->
								<div class="mt-4 text-right">
									<button type="submit" class="btn btn-success w-230px btn-md rounded-2 fs-14 fw-700 shadow-success">{{ translate('Update') }}</button>
