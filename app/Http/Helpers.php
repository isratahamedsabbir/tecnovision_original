...
if (!function_exists('get_single_attribute_name')) {
    function get_single_attribute_name($attribute)
    {
        ...
        $attribute = $attribute_query->find($attribute);
        return $attribute != null ? $attribute->getTranslation('name') : null;
    }
}
...
if (!function_exists('allCacheClear')) {
    function allCacheClear(): void
    {
