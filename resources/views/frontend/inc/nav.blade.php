                                                ...
                                                @forelse($user->unreadNotifications as $notification)
                                                    ...
                                                    @if($showNotification)
                                                        @php
                                                            ...
                                                            $notifyContent = $notificationType ? $notificationType->getTranslation('default_text') : null;
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div>
                                                                    @if ($notification->type == 'App\Notifications\OrderNotification')
                                                                        @php
                                                                            if(isset($notification->data['order_code']) && !empty($notification->data['order_code'])){
