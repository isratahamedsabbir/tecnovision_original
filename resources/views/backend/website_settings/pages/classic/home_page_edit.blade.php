		...
		<div class="d-sm-flex">
			...
			<div class="page-side-nav c-scrollbar-light px-3 py-2">
				<ul class="nav nav-tabs flex-sm-column border-0" role="tablist" aria-orientation="vertical">
					...
					<li class="nav-item">
						<a class="nav-link" id="home-banner-tab" href="#home_banner"
							data-toggle="tab" data-target="#home_banner" type="button" role="tab" aria-controls="home_banner" aria-selected="true">
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade" id="home_slider" role="tabpanel" aria-labelledby="home-slider-tab">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							@csrf
							<input type="hidden" name="tab" value="home_banner">
					...
					<!-- Bottom Home Banner -->
					<div class="tab-pane fade" id="home_banner" role="tabpanel" aria-labelledby="home-banner-tab">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							@csrf
							<input type="hidden" name="tab" value="home_banner">
							<div class="bg-white p-3 p-sm-2rem">
								<div class="row">
									<div class="col-md-6">
										<label class="col-from-label fs-13 fw-500 mb-3">{{ translate('Top Home Banner') }}</label>
										<!-- Images -->
										<div class="form-group">
											<div class="input-group" data-toggle="aizuploader" data-type="image">
												...
												<div class="form-control file-amount">{{ translate('Choose File') }}</div>
												<input type="hidden" name="types[][{{ $lang }}]" value="top_banner_image">
												<input type="hidden" name="top_banner_image" class="selected-files" value="{{ get_setting('top_banner_image', null, $lang) }}">
											</div>
											<div class="file-preview box sm">
											</div>
									...
									<div class="col-md-6">
										<label class="col-from-label fs-13 fw-500 mb-3">{{ translate('Top Banner Link') }}</label>
										<input type="hidden" name="types[][{{ $lang }}]" value="top_banner_link">
										<input type="text" name="top_banner_link" class="form-control" placeholder="{{ translate('Enter URL') }}" value="{{ get_setting('top_banner_link', null, $lang) }}">
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<label class="col-from-label fs-13 fw-500 mb-3">{{ translate('Bottom Home Banner') }}</label>
										<!-- Images -->
										<div class="form-group">
											<div class="input-group" data-toggle="aizuploader" data-type="image">
												<div class="input-group-prepend">
												...
												<div class="form-control file-amount">{{ translate('Choose File') }}</div>
												<input type="hidden" name="types[][{{ $lang }}]" value="bottom_banner_image">
												<input type="hidden" name="bottom_banner_image" class="selected-files" value="{{ get_setting('bottom_banner_image', null, $lang) }}">
											</div>
											<div class="file-preview box sm">
											</div>
											<small class="text-muted">{{ translate("Minimum dimensions required: 435px width X 485px height.") }}</small>
									...
									<div class="col-md-6">
										<label class="col-from-label fs-13 fw-500 mb-3">{{ translate('Bottom Banner Link') }}</label>
										<input type="hidden" name="types[][{{ $lang }}]" value="bottom_banner_link">
										<input type="text" name="bottom_banner_link" class="form-control" placeholder="{{ translate('Enter URL') }}" value="{{ get_setting('bottom_banner_link', null, $lang) }}">
									</div>
								</div>
								<!-- Save Button -->
								<div class="mt-4 text-right">
