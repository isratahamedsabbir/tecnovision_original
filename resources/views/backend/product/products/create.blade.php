                    ...
                    <div class="bg-white p-3 p-sm-2rem">
                        ...
                        <div class="w-100">
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <textarea class="aiz-text-editor" name="key_features">{{ old('key_features') }}</textarea>
                                </div>
                            </div>
                            <!-- Description -->
                            <div class="form-group">
                        ...
                        <div class="w-100">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <label class="aiz-switch aiz-switch-success mb-0 d-block">
                                        <input type="checkbox" name="on_homepage" value="1">
                                        <span></span>
                                    </label>
                    ...
                    <div class="bg-white p-3 p-sm-2rem">
                        ...
                        <div class="w-100">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" lang="en" min="1" value="1" step="0.01" placeholder="1" name="unit_price" class="form-control @error('unit_price') is-invalid @enderror">
                                </div>
                            </div>
                            <!-- Discount Date Range -->
                            <div class="form-group row">
                    ...
                    <div class="bg-white p-3 p-sm-2rem">
                        ...
                        <div class="w-100">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="{{ translate('Meta Keywords') }}">
                                </div>
                            </div>
                            <!-- Description -->
                            <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select style="width: 100%; display: block;" class="form-control js-example-basic-multiple" id="filter_title" name="filters[]" multiple="multiple" onchange="filterOptions()">
                                    ...
                                    <option value="{{ $filter->name }}" data-id="{{ $filter->id }}">{{ $filter->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
        ...
        if (Array.isArray(filterTitle) && filterTitle.length > 0) {
            filterTitle.forEach(function(value) {
                ...
                $('#filter_value_div').append(`
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">${value.charAt(0).toUpperCase() + value.slice(1)}</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="filter_value[${id}]" placeholder="Enter Product ${value}" required>
                        </div>
                    </div>
                `);
            });
