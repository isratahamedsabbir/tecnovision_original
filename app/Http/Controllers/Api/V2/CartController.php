...
class CartController extends Controller
{
    ...
    {
        $user_id =  auth('sanctum')->user()->id != null ? auth('sanctum')->user()->id : null;
        ...
        $product = Product::where('published', 1)->where('upcoming', 0)->find($request->id);
    ...
    public function remove(Request $request)
    {
        ...
        if ($cart != null) {
            if ($cart->delete()) {
                return response()->json(['result' => true, 'message' => translate('Cart removed successfully')], 200);
            }
        }
    ...
    public function clean(Request $request)
    {
        ...
        return response()->json(['result' => true, 'message' => translate('Cart cleaned successfully')], 200);
    }
    ...
    public function changeQuantity(Request $request)
    {
        ...
        if ($cart != null) {
            $product = Product::where('published', 1)->where('upcoming', 0)->find($cart->product_id);
