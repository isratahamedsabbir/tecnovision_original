        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th data-breakpoints="lg">{{translate('Top')}}</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" onchange="update_top(this)" value="{{ $category->id }}" <?php if($category->top == 1) echo "checked";?>>
                                <span></span>
                            </label>
                        </td>
                        <td>
...
@section('script')
    <script type="text/javascript">
        ...
        function update_top(el){
            ...
            $.post("{{ route('categories.top') }}", {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    AIZ.plugins.notify('success', "{{ translate('Top categories updated successfully') }}");
                }
                else{
                    AIZ.plugins.notify('danger', "{{ translate('Something went wrong') }}");
                }
