    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                @else
                <img class="mw-100" src="{{ static_asset('default/logo.webp') }}" class="brand-icon"
                    alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('view_product_filters')
                            <li class="aiz-side-nav-item d-none">
                                <a href="{{route('filters.index')}}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['filters.index', 'filters.create', 'filters.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Filter')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('product-faqs.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['product-faqs.index', 'product-faqs.create', 'product-faqs.edit']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Product FAQs') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                            ...
                            @can('view_all_product_questions')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('product-queries.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['product-queries.index']) }}">
                                        <span class="aiz-side-nav-text">{{translate('Product Questions')}}</span>
                                    </a>
                                </li>
                            @endcan

                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{route('products.suggected-product-view')}}">
                                    <span class="aiz-side-nav-text">Set Suggested Products</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('shipping_charges.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['shipping_charges.create', 'shipping_charges.edit'])}}">
                                    <span class="aiz-side-nav-text">Shipping Charges</span>
                                </a>
                            </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('custom-pages.edit', ['id'=>'auth', 'lang'=>env('DEFAULT_LANGUAGE'), 'page'=>'auth']) }}"
                                class="aiz-side-nav-link {{ (url()->current() == url('/admin/website/custom-pages/edit/auth ')) ? 'active' : '' }}">
                                <span class="aiz-side-nav-text">{{translate('Authpage Settings')}}</span>
                            </a>
                        </li>
                        @endcan
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('districts.index')}}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['districts.index','districts.edit','districts.update'])}}">
                                        <span class="aiz-side-nav-text">Shipping District</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('upazilas.index')}}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['upazilas.index','upazilas.edit','upazilas.update'])}}">
                                        <span class="aiz-side-nav-text">Shipping Upazila</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
