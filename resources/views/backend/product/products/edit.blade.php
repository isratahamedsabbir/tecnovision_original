...
<div class="page-content">
 ...
 --}}
                <!-- Filter -->
                {{-- <li class="nav-item">
                    <a class="nav-link" id="filter-product-tab" href="#filters-product"
                        data-toggle="tab" data-target="#filters-product" type="button" role="tab" aria-controls="filters-product" aria-selected="false">
                        {{ translate("Filter") }}
                    </a>
                </li> --}}
        ...
        <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
            ...
            <form action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="tab-content">
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row" id="brand">
                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Brand')}} <span class="text-danger">*</span></label>
                                            <div class="col-xxl-9">
                                        ...
                                        <!-- Product Type -->
                                        <div class="form-group row" id="product_type">
                                            <label class="col-xxl-3 col-from-label fs-13">Product Type <span class="text-danger">*</span></label>
                                            <div class="col-xxl-9">
                                                <select class="form-control aiz-selectpicker" name="product_type_id" id="product_type_id" data-live-search="true">
                                        ...
                                        <div class="form-group row" id="country">
                                            <label class="col-xxl-3 col-from-label fs-13">Made In <span class="text-danger">*</span></label>
                                            <div class="col-xxl-9">
                                ...
                                <div class="form-group">
                                    <label class="fs-13">{{translate('Key Features')}}</label>
                                    <div class="">
                                        <textarea class="aiz-text-editor" name="key_features">{{ $product->getTranslation('key_features', $lang) }}</textarea>
                                    </div>
                                </div>
                                ...
                                <!-- Short Description -->
                                <div class="form-group">
                                    <label class="fs-13">Short Description</label>
                                    <div class="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea class="aiz-text-editor" name="specification">{{ $product->getTranslation('specification', $lang) }}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="w-100">
                                <!--Upcoming -->
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Upcoming')}}</label>
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0 d-block">
                                            <input type="checkbox" name="upcoming" value="1" @if($product->upcoming == 1) checked @endif>
                                            <span></span>
                                        </label>
                                        <small class="text-muted">{{ translate('If you enable this, this product will be granted as a upcoming product.') }}</small>
                                    </div>
                                </div>
                                <!-- Best Seller -->
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Best Seller')}}</label>
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0 d-block">
                                            <input type="checkbox" name="best_seller" value="1" @if($product->best_seller == 1) checked @endif>
                                            <span></span>
                                        </label>
                                        <small class="text-muted">{{ translate('If you enable this, this product will be granted as a best seller product.') }}</small>
                                    </div>
                                </div>
                                <!-- Featured -->
                                <div class="form-group row">
                                ...
                                <!-- Show in Homepage -->
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Show in Homepage')}}</label>
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0 d-block">
                                            <input type="checkbox" name="on_homepage" value="1" @if($product->on_homepage == 1) checked @endif>
                                            <span></span>
                                        </label>
                                        <small class="text-muted">{{ translate('If you enable this, this product will be shown in homepage.') }}</small>
                                    </div>
                                </div>
                                <!-- Todays Deal -->
                                <div class="form-group row">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <small class="text-muted">These images are visible in product details page gallery. Minimum dimensions required: <b class='text-info bg-soft-info'>860px width</b> X <b class='text-info bg-soft-info'>740px height</b>.</small>
                                    </div>
                                </div>
                                <!-- Thumbnail Image -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <small class="text-muted">This image is visible in all product box. Minimum dimensions required: <b class='text-info bg-soft-info'>860px width</b> X <b class='text-info bg-soft-info'>740px height</b>. Keep some blank space around main object of your image as we had to crop some edge in different devices to make it responsive.</small>
                                    </div>
                                </div>
                            </div>
                            <!-- Video Provider -->
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" min="1" step="0.01" placeholder="{{translate('Unit price')}}" name="unit_price" class="form-control @error('unit_price') is-invalid @enderror" value="{{$product->unit_price}}">
                                    </div>
                                </div>
                                ...
                                <div id="show-hide-div">
                                    ...
                                    <div class="form-group row" id="quantity">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" lang="en" value="{{ optional($product->stocks->first())->qty ?? 100 }}" step="1" placeholder="{{translate('Quantity')}}" name="current_stock" class="form-control">
                                        </div>
                                    </div>
                                    <!-- SKU -->
                                    <div class="form-group row">
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="meta_keywords" value="{{ $product->meta_keywords }}" placeholder="Meta Keywords">
                                    </div>
                                </div>
                                <!-- Description -->
                                <div class="form-group row">
                    ...
                    <!-- Filter -->
                    <div class="d-none tab-pane fade" id="filters-product" role="tabpanel" aria-labelledby="filters-product-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            <!-- Filter Title -->
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Filter Title')}}</label>
                                <div class="col-md-9">
                                    <select style="width: 100%; display: block;" class="form-control js-example-basic-multiple" id="filter_title" name="filters[]" multiple="multiple" onchange="filterOptions()">
                                        @foreach ($filters as $filter)
                                        <option value="{{ $filter->name }}" data-id="{{ $filter->id }}" @if(isset($product->filters) && in_array($filter->id, json_decode($product->filters))) selected @endif>{{ $filter->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <!-- Filter Value -->
                            <div class="" id="filter_value_div"></div>
...
<script>
    ...
    function filterOptions() {
        $('#filter_value_div').empty();
        var filterTitle = $('#filter_title').val();
        var filtersProducts = @json($filters_products);

        if (Array.isArray(filterTitle) && filterTitle.length > 0) {
            filterTitle.forEach(function(value) {
                var id = $('#filter_title option[value="' + value + '"]').attr('data-id');
                var existingValue = filtersProducts[id] ?? ''; // Get value if exists

                $('#filter_value_div').append(`
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">
