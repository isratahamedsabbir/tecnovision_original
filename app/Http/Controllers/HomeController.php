...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if(CustomEnum::FRONTEND->value == 'no') {
           return view('home'); 
        }
    ...
    public function product(Request $request, $slug)
    {
        ...
        $detailedProduct  = Product::with('reviews', 'brand', 'stocks', 'user', 'user.shop', 'faqs.faq_translations')->where('auction_product', 0)->where('slug', $slug)->where('approved', 1)->first();
