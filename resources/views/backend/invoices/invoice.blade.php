	...
	<div>
			...
			<table>
				<tr>
					<td>
						...
						@else --}}
							<img src="{{ static_asset('default/green_logo.png') }}" height="30" style="display:inline-block;">
						{{-- @endif --}}
					</td>
		...
		<div style="padding: 1rem;padding-bottom: 0">
            <table>
				...
				@endphp
				<tr><td class="strong small gry-color">{{ translate('Bill to') }}: {{ $shipping_address->name }}</td></tr>
				<tr><td class="gry-color small">Address: {{ $shipping_address->address }}, {{ $shipping_address->city ?? ''}}</td></tr>
				<tr><td class="strong small gry-color">Shipping to: {{ $order->shipping_charge->name }}</td></tr>
