			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<div class="form-group">
								<input type="hidden" name="types[]" value="topbar_video_link">
								<input type="text" class="form-control" placeholder="{{ translate('Link with') }} http:// {{ translate('or') }} https://" name="topbar_video_link" value="{{ get_setting('topbar_video_link') }}">
							</div>
						</div>
					</div>
                    ...
                    <div class="border-top pt-3">
						...
						<div class="form-group row">
							<label class="col-md-3 col-from-label">{{translate('Help line email')}}</label>
							<div class="col-md-8">
								<div class="form-group">
									<input type="hidden" name="types[]" value="helpline_email">
									<input type="text" class="form-control" placeholder="{{ translate('Help line email') }}" name="helpline_email" value="{{ get_setting('helpline_email') }}">
								</div>
							</div>
						</div>
                    </div>
