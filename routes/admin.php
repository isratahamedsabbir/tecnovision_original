...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(CategoryController::class)->group(function () {
        ...
        Route::post('/categories/top', 'updateTop')->name('categories.top');
    ...
    Route::get('filters/destroy/{id}', [FilterController::class, 'destroy'])->name('filters.destroy');
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/on_homepage', 'updateOnHomepage')->name('products.on_homepage');
        Route::post('/products/upcoming', 'updateUpcoming')->name('products.upcoming');
        ...
        Route::get('/products/suggected-product-view', 'suggestedProductView')->name('products.suggected-product-view');
        Route::get('/products/suggected-product-edit/{id}', 'suggestedProductEdit')->name('products.suggected-product-edit');
        Route::post('/products/suggected-product-store', 'suggestedProductStore')->name('products.suggected-product-store');
        Route::get('/products/suggested/{id}', 'suggested');
    });
    ...
    Route::controller(ContactController::class)->group(function () {
        ...
        Route::get('/contacts/destroy/{id}', 'destroy')->name('contact.destroy');
    });
    ...
    Route::group(['prefix' => 'website'], function () {
        Route::controller(WebsiteController::class)->group(function () {
            ...
            Route::post('/pages/status', 'pageStatus')->name('website.pages.status');
        });
    ...
    Route::controller(ProductQueryController::class)->group(function () {
        ...
        Route::get('/product-queries/destroy/{id}', 'destroy')->name('product_query.destroy');
        Route::post('/product-queries/published', 'updatePublished')->name('product_query.published');
    });

    // Product FAQs
    Route::resource('product-faqs', ProductFaqController::class);
    Route::controller(ProductFaqController::class)->group(function () {
        Route::post('/product-faqs/update-status', 'updateStatus')->name('product-faqs.update-status');
    });
    ...
    Route::controller(DistrictController::class)->group(function () {
        Route::get('/districts/edit/{id}', 'edit')->name('districts.edit');
    ...
    Route::controller(UpazilaController::class)->group(function () {
        Route::get('/upazilas/edit/{id}', 'edit')->name('upazilas.edit');
        Route::get('/upazilas/destroy/{id}', 'destroy')->name('upazilas.destroy');
        Route::post('/upazilas/status', 'updateStatus')->name('upazilas.status');
    });
...
Route::resource('admin/shipping_charges', ShippingChargeController::class);
Route::get('admin/shipping_charges/destroy/{id}', [ShippingChargeController::class, 'destroy'])->name('shipping_charges.destroy');
