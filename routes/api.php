...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::post('temporary-password', [TemporaryPasswordController::class, 'sendSms']);
    ...
    Route::controller(CartController::class)->group(function () {
        ...
        Route::post('carts/remove', 'remove');
        Route::get('carts/clean', 'clean');
    ...
    Route::get('order/{code}', 'App\Http\Controllers\Api\V2\ProfileController@order');
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        Route::controller(WishlistController::class)->middleware('auth:sanctum')->group(function () {
            ...
            Route::post('wishlists-add-product', 'add');
            Route::post('wishlists-remove-product', 'remove');
        ...
        Route::get('profile/details', 'App\Http\Controllers\Api\V2\ProfileController@details')->middleware('auth:sanctum');
        ...
        Route::post('profile/update-password', 'App\Http\Controllers\Api\V2\ProfileController@updatePassword')->middleware('auth:sanctum');
        ...
        Route::get('orders', 'App\Http\Controllers\Api\V2\ProfileController@orders')->middleware('auth:sanctum');
    ...
    Route::get('sub-categories/{slug}', 'App\Http\Controllers\Api\V2\SubCategoryController@index')->name('subCategories.index');
    ...
    Route::get('filter/options', 'App\Http\Controllers\Api\V2\FilterController@filterOptions');
    ...
    Route::get('products/homepage', 'App\Http\Controllers\Api\V2\ProductController@homePage');
    Route::get('products/upcoming', 'App\Http\Controllers\Api\V2\ProductController@upcoming');
    Route::get('products/thirty-days', 'App\Http\Controllers\Api\V2\ProductController@thirtyDays');
    ...
    Route::get('products/micro/search', 'App\Http\Controllers\Api\V2\ProductController@microSearch');
    ...
    Route::controller(BlogController::class)->group(function () {
        ...
        Route::get('blog-list/{slug?}', 'blog_list');
...
Route::group(['prefix' => 'v2'], function () {
    ...
    Route::get('upazilas/{district_id?}', [AuthController::class, 'getUpazilas']);
    Route::get('shipping_charges', [ShippingChargeController::class, 'index']);
});
